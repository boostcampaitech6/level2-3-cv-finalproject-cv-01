...
def save_plot(ohlc: pd.DataFrame, point: int, save_dir) -> None:
    """
    Save the plot 
    ...
    fn   = f"support-resistance-{point}.png"
...
if __name__ == "__main__":
    ...
    ohlc["Date"] = pd.to_datetime(ohlc["Date"], format='mixed')
    ...
    while end < len(ohlc):
        ...
        save_folder = '/data/ephemeral/home/Final_Project/Graph_matching/code/images/test'
        save_dir = os.path.join(save_folder, 'eurusd')
        ...
        if res_idx == 0 and sup_idx == 0:
            ...
            save_plot(ohlc_sub, end, save_dir)
