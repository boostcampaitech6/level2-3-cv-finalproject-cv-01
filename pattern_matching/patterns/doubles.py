...
def save_plots(ohlc, patterns, max_min, save_dir, filename):
    """
...
if __name__ == "__main__":
    ...
    save_plots(ohlc, patterns_tops, max_min, save_dir, "double-tops")
    ...
    save_plots(ohlc, patterns_bottoms, max_min, save_dir, "double-bottoms")
